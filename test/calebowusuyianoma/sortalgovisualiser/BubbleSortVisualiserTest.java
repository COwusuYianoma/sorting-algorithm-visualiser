...
class BubbleSortVisualiserTest {
    ...
    public void fillRectangleThrowsExceptionWhenGraphicsObjectIsNull() {
        ...
        // Act
        Exception exception = assertThrows(IllegalArgumentException.class, () ->
                bubbleSortVisualiser.fillRectangle(null, 1, 1, 1, 1, 1,
                        data));
    ...
    public void fillRectangleThrowsExceptionWhenDataIsNull() {
        ...
        // Act
        Exception exception = assertThrows(IllegalArgumentException.class, () ->
                bubbleSortVisualiser.fillRectangle(g, 1, 1, 1, 1, 1,
                        null));
    ...
    public void fillRectangleCallsFillRectWithCorrectParameters() {
        ...
        // Act
        bubbleSortVisualiser.fillRectangle(g, 1, 1, 1, xCoordinate, width, data);
